...
<div class="panel-display sutro-double clearfix <?php if (!empty($classes)) { print $classes; } ?><?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="container">
    <div class="row-fluid sutro-double-header">
    ...
    <div class="row-fluid sutro-double-columns">
      <div class="span6 sidebar panel-panel">
        <div class="panel-panel-inner">
    ...
    <div class="row-fluid sutro-double-middle">
      <div class="span12 panel-panel">
        <div class="panel-panel-inner">
    ...
    <div class="row-fluid sutro-double-bottom-columns">
      <div class="span6 sidebar panel-panel">
        <div class="panel-panel-inner">
    ...
    <div class="row-fluid sutro-doubl-footer">
      <div class="span12 panel-panel">
        <div class="panel-panel-inner">
